...
Routes and other initialization are configured in `lib/__projectName___sink.dart`. Endpoint controllers file are in `lib/controller/`.
...
aqueduct auth add-client \
    --id com.__projectName__.mobile
    --secret myspecialsecret
    --connect postgres://user:password@host:5432/__projectName__
```
